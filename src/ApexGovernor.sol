...
contract ApexGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    constructor(IVotes _token, TimelockController _timelock)
        Governor("ApexGovernor")
        GovernorSettings(1 days, 1 weeks, 0) // Задержка начала 1 день, длится 1 неделю
        GovernorVotes(_token)
        GovernorVotesQuorumFraction(4) // Чтобы закон прошел, нужно хотя бы 4% от всех токенов
